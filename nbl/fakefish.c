 ...
 *
 * NOTE: SEGA's implementation is different here.
 * The endianness is opposite of what's expected.
 */
...
#define bf_F(x) (((S[GET32_3(x)] + S[256 + GET32_2(x)]) ^ \
          S[512 + GET32_1(x)]) + S[768 + GET32_0(x)])
